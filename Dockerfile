...
# Ensure the non-root user has access to the workspace
RUN mkdir -p /catkin_ws && chown -R $USER_UID:$USER_GID /catkin_ws
...
RUN export ROS_MASTER_URI=http://192.180.1.5:11311
RUN export ROS_IP=192.180.1.5
